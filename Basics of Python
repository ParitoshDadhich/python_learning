...
# 4. Variable names are case sensitive. Paritosh and paritosh are two different variables
...
paritoshDict["Marks"] = 34
# print(paritoshDict["Marks"])
paritoshDict.pop("Marks")
...
paritosh = Employee("paritosh", 34)
print(paritosh.name)
print(paritosh.salary)
